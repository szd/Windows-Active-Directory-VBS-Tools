Option Explicit
 '
 ' Add users from a CSV file in an Active Directory Security Group
 '
 ' Author : Steve ZD
 '
...
' Use the NameTranslate object to find the NetBIOS domain name from the
 ...
 If WScript.Arguments.Count<>2 Then
	Wscript.Echo "CSV File or AD Group missing." & VbCrLf & "Syntax : AddUsersInGroup.vbs <CSV_Path> AD_GROUP_NAME"
Else
' Specify input file.
