Option Explicit
  '
 ' Remove ScriptPath and HomeFolder properties for users given in a CSV file
 '
 ' Author : Steve ZD
 '
...
' Use the NameTranslate object to find the NetBIOS domain name from the
 ...
 If WScript.Arguments.Count<>1 Then
	Wscript.Echo "CSV file missing." & VbCrLf & "Syntax : RemoveScriptPathAndHomeFolder.vbs <CSV_PATH>"
Else
' Specify input file.
